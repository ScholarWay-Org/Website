...
from helpers.helpers import truncateDescription # Need to make this function
from helpers.helpers import format_course_names # And this too... The descriptions are too long.
...
# Outline for the course builder tool
